(function() {
  ...
  assessmentButton.onclick = () => {
    ...
    paragraph.innerText = result; // <p>{userName}</p>
    ...
    tweetDivided.appendChild(anchor); // 挿入
    twttr.widgets.load();
  };
  ...
  userNameInput.onkeydown = event => {
    if (event.keyCode === 13) {
      ...
      assessmentButton.onclick(); // assessmentButton.onclick に代入されている関数を呼び出す
    }
  };
